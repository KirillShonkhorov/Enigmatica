...
public class SHA2Activity extends AppCompatActivity{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sha2);
        ...
        InputHash.setOnClickListener(v -> {
            String url = "https://api.hashify.net/hash/sha256/hex?value=" + InputEditTExt.getText();
    ...
    private void GetHash(String url,EditText outputLink,EditText outputEditText) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                SHA2Activity.this.runOnUiThread(() -> {
